...
const EmailLoginPage = () => {
    ...
    const onFinish = (values) => {
        axios.get(`http://localhost:8080/user/login/1/${values.username}/${values.password}`)
            .then(response => {
                if(response.data.loginStatus === 0) {
                    navigate('/main', {state: {userId: response.data.userId, token: response.data.token}});
    ...
    return(
        <div className="email-login-background-container">
            <div className="email-login-body-container">
                <div className="email-login-header-container">
